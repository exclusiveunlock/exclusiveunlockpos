        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="card-body">
                    <div class="flex flex-col md:flex-row items-center space-y-6 md:space-y-0 md:space-x-8">
                        ...
                        <div class="text-center space-y-2">
                            <div class="text-4xl font-bold gradient-text animate-number-grow">{{ auth()->user()->downloads_count ?? 0 }}</div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-8 animate-fade-in-up animation-delay-400">
                ...
                <div class="lg:col-span-1">
                    <nav class="space-y-3" x-data="{ activeTab: 'profile' }">
                        ...
                        <button @click="activeTab = 'danger'" 
                                :class="activeTab === 'danger' ? 'bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400 border-red-200 dark:border-red-800 shadow-md' : 'bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 border-gray-200 dark:border-gray-700 hover:border-red-300 dark:hover:border-red-700'"
                                class="w-full text-left px-5 py-3 rounded-xl border transition-all duration-300 flex items-center space-x-3 transform hover:-translate-y-0.5">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="lg:col-span-3">
                    ...
                    <!-- Security Tab -->
                    <div x-show="activeTab === 'security'" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform -translate-x-4" x-transition:enter-end="opacity-100 transform translate-x-0" class="space-y-6 animate-fade-in">
                        <!-- Change Password -->
                        <div class="card">
                            <div class="card-body">
                                <h3 class="text-2xl font-semibold text-gray-900 dark:text-white mb-6">Change Password</h3>
                    ...
                    <!-- Danger Zone Tab -->
                    <div x-show="activeTab === 'danger'" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform -translate-x-4" x-transition:enter-end="opacity-100 transform translate-x-0" class="card border-red-200 dark:border-red-800 animate-fade-in">
                        <div class="card-body">
                            <h3 class="text-2xl font-semibold text-red-600 dark:text-red-400 mb-6">Danger Zone</h3>
