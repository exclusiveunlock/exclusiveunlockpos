            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color: #ffffff; border-radius: 10px;">
                <tr>
                    <td style="padding: 30px;">
                        <h1 style="font-size: 24px; color: #333333; margin-top: 0;">Package Assigned!</h1>
                        <p style="font-size: 16px; color: #555555;">Hi {{ $user->name }},</p>
                        <p style="font-size: 16px; color: #555555;">A new package, <strong>{{ $package->title }}</strong>, has been assigned to your account by an administrator.</p>
                        ...
                        <p style="font-size: 16px; color: #555555;">You can now enjoy the benefits of your new package. Visit your dashboard to see the changes.</p>
                        <!-- Button -->
