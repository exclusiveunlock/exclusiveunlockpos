<x-modern-guest-layout>
    ...
    <div class="text-center mb-8">
        <div class="w-16 h-16 bg-gradient-to-br from-blue-500 via-purple-600 to-pink-500 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-xl">
            <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path>
            </svg>
        </div>
        <h2 class="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-white mb-3">Welcome Back</h2>
        <p class="text-base sm:text-lg text-gray-600 dark:text-gray-400">Sign in to access your firmware downloads and manage your account</p>
    </div>
    ...
    <form method="POST" action="{{ route('login') }}" class="space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-3 sm:space-y-0">
            <div class="flex items-center">
                ...
                <label for="remember_me" class="ml-3 text-sm font-medium text-gray-700 dark:text-gray-300">
                    Remember me
                </label>
            </div>
        ...
        <!-- Login Button -->
        <button type="submit" 
                class="w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-semibold py-4 px-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-[1.02] focus:outline-none focus:ring-4 focus:ring-blue-500/20">
    ...
    <div class="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 text-center">
            <div class="flex flex-col items-center p-3 rounded-lg bg-gray-50 dark:bg-gray-800/50">
                ...
                <span class="text-xs font-medium text-gray-600 dark:text-gray-400">Secure Login</span>
            </div>
            <div class="flex flex-col items-center p-3 rounded-lg bg-gray-50 dark:bg-gray-800/50">
                <svg class="w-6 h-6 text-blue-500 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z"></path>
                </svg>
                <span class="text-xs font-medium text-gray-600 dark:text-gray-400">Mobile Ready</span>
            </div>
            <div class="flex flex-col items-center p-3 rounded-lg bg-gray-50 dark:bg-gray-800/50">
                <svg class="w-6 h-6 text-purple-500 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"></path>
                </svg>
                <span class="text-xs font-medium text-gray-600 dark:text-gray-400">Fast Access</span>
            </div>
        </div>
    </div>
</x-modern-guest-layout>
